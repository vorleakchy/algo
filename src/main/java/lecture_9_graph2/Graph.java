...
//        System.out.println(tree);
		...
		System.out.println("Path A-Z: " + g.shortestPathLength(new Vertex("A"), new Vertex("Z")));

		System.out.println("Path B-C: " + g.shortestPathLength(new Vertex("B"), new Vertex("C")));
		System.out.println("Path A-D: " + g.shortestPathLength(new Vertex("A"), new Vertex("D")));
		System.out.println("Path E-F: " + g.shortestPathLength(new Vertex("E"), new Vertex("F")));
	}
}
